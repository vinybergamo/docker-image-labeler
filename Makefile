...
EMAIL = contact@vinybergamo.com
MAINTAINER = vinybergamo
MAINTAINER_NAME = Vinycios Bergamo
REPOSITORY = docker-image-labeler
HARDWARE = $(shell uname -m)
SYSTEM_NAME  = $(shell uname -s | tr '[:upper:]' '[:lower:]')
BASE_VERSION ?= 0.5.0
IMAGE_NAME ?= $(MAINTAINER)/$(REPOSITORY)
PACKAGECLOUD_REPOSITORY ?= vinybergamo/vinybergamo-betafish
...
bin/gh-release-body:
	mkdir -p bin
	curl -o bin/gh-release-body "https://raw.githubusercontent.com/vinybergamo/gh-release-body/master/gh-release-body"
